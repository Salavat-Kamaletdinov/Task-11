...
@WithMockUser(username = "salavat", password = "1000", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        userRequest = new UserRequest("salavat", "100@yandex.ru", "1000", "Alex", "Spensor");
    }
    ...
    void testHello() throws Exception {
        ...
        assertEquals("salavat", responseContent);
    }

    @Test
    void create() {
        UserRequest userRequest = new UserRequest("salavat", "123@mail.com", "1000", "Oleg", "Nadich");
        try {
